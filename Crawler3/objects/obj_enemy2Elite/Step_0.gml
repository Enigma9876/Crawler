...
else
{
	...
	if(damaged && !isAttacking)
	{
		...
		damaged = false;
		isDamaged = true;
		sprite_index = spr_enemy2DamageElite;
	}
	...
	if(sprite_index == spr_enemy2DamageElite && image_index >= 2 && isDamaged)
	{
		damaged = false;
		isDamaged = false;
		sprite_index = spr_enemy2Elite;
	}
	if(sprite_index == spr_enemy2AttackElite && image_index >= 2 && isAttacking)
	{
		attacking = false;
		isAttacking = false;
		sprite_index = spr_enemy2Elite;
	...
	if(sprite_index == spr_enemy2AttackElite && !isAttacking && !attacking)
	{
		sprite_index = spr_enemy2Elite;
	}
